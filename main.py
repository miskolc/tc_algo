...
if __name__ == '__main__':
    ...
    #                                    backtest_chart=ChartType.COLUMN, patterns=[Pattern.harami_pattern])
    ...
    data_prop, params, data_list, pattern_data = data_parser.data_builder(data, data_prop, patterns=patterns)
    # print(pattern_data)
    result = {
