...
if __name__ == '__main__':
    ...
    # op.data_insertion.update_option_greeks(date(2018, 11, 2))
    # op.data_insertion.update_option_greeks(date(2018, 11, 5))
    # op.data_insertion.update_option_greeks(date(2018, 11, 6))
